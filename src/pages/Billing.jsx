    ...
    <DashboardLayout>
      ...
      <div className="p-2 sm:p-4 md:p-6 bg-gray-50 min-h-screen">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <KpiCard title="Food Revenue Today" value={kpiData.food_revenue_today.toLocaleString()} prefix="Γé╣" icon={<Utensils size={22} className="text-yellow-600"/>} color="bg-yellow-100" />
          ...
          <div className="lg:col-span-3 bg-white p-6 rounded-xl shadow-md">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={chartData.weekly_performance} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
                ...
                <Legend />
                <Bar yAxisId="left" dataKey="revenue" fill="#4f46e5" name="Revenue (Γé╣)" />
              ...
              return (
                <div className={`mt-2 p-3 ${isMultiple ? 'bg-blue-50 border-blue-200' : 'bg-green-50 border-green-200'} border rounded-lg text-sm ${isMultiple ? 'text-blue-800' : 'text-green-800'}`}>
                  <p className="font-semibold">
                    {isMultiple ? "ΓÜá∩╕Å Important: This will checkout ALL rooms in the booking" : "Γ£ô Single Room Checkout: Only this room will be checked out"}
                  </p>
          ...
          {billData && (
            <>
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  <label htmlFor="discount" className="block text-gray-700 font-medium mb-2">Discount (Γé╣)</label>
        ...
        <div className="bg-white p-3 sm:p-6 rounded-xl shadow-md w-full max-w-7xl mx-auto">
          ...
          <div className="bg-gray-50 p-4 rounded-lg mb-4 border border-gray-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
              ...
              {/* Min Amount */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Min Amount (Γé╣)</label>
                <input
                  type="number"
                  value={minAmount}
              ...
              {/* Max Amount */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Max Amount (Γé╣)</label>
                <input
                  type="number"
                  value={maxAmount}
