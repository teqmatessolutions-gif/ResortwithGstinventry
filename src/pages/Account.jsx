    ...
    <DashboardLayout>
      ...
      <div className="p-6 md:p-8 space-y-8 bg-gray-50 min-h-screen">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-5">
          ...
          <KpiCard title="Total Expenses" value={kpiData.total_expenses || 0} prefix="Γé╣" loading={loading} icon={<DollarSign className="text-red-500 w-8 h-8" />} />
          ...
          <KpiCard title="Total Salary" value={kpiData.total_salary || 0} prefix="Γé╣" loading={loading} icon={<Briefcase className="text-gray-600 w-8 h-8" />} />
          ...
          <SectionCard title="Weekly Performance" icon={<TrendingUp className="text-blue-600" />} loading={chartLoading} className="lg:col-span-3">
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={chartData.weekly_performance}>
                ...
                <Tooltip />
                <Legend />
                <Bar yAxisId="left" dataKey="revenue" fill="#8884d8" name="Revenue (Γé╣)" />
