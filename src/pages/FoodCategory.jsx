    ...
    <DashboardLayout>
      <div className="p-6 space-y-12">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">≡ƒì╜∩╕Å Food Item Management</h2>
          <form
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    <div className="flex justify-between items-start">
                      ...
                      <p className="text-indigo-600 font-bold text-xl">Γé╣{item.price}</p>
                    </div>
        ...
        {/* ====================================================== */}
        <div className="bg-white p-8 rounded-2xl shadow-lg">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">≡ƒÅ╖∩╕Å Food Category Management</h2>
          <form
