      ...
      <div className="flex flex-wrap gap-4 p-4 border border-gray-300 rounded-lg bg-gray-50 max-h-64 overflow-y-auto">
        {rooms.length > 0 ? (
          ...
          <div className="w-full text-center py-8 text-gray-500">
            <div className="text-lg mb-2">≡ƒÜ½</div>
          ...
          >
            ...
            <form onSubmit={handlePackageBookingSubmit} className="flex flex-col h-full">
              ...
              <button
                ...
                disabled={isSubmitting || isLoading}
              >
                {isSubmitting ? "Booking..." : "Book Package Γ£à"}
              </button>
            </form>
          </motion.div>
        </div>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3 items-stretch sm:items-center w-full sm:w-auto">
              <div className="flex flex-col w-full sm:w-auto">
                ...
                >
                  ...
                  <option value="booked">≡ƒôà Booked ({statusCounts.booked})</option>
                  <option value="checked-in">Γ£à Checked-in ({statusCounts['checked-in']})</option>
                  <option value="checked-out">≡ƒÜ¬ Checked-out ({statusCounts['checked-out']})</option>
                  <option value="cancelled">Γ¥î Cancelled ({statusCounts.cancelled})</option>
                </select>
              </div>
              <div className="flex flex-col w-full sm:w-auto">
