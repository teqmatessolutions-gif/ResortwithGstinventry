 ...
 * @param {boolean} showSymbol - Whether to show Γé╣ symbol (default: true)
 * @param {number} decimals - Number of decimal places (default: 2)
 * @returns {string} Formatted amount string like "Γé╣10,000.00" or "1,000.00"
 */
export const formatCurrency = (amount, showSymbol = true, decimals = 2) => {
  ...
  return showSymbol ? `Γé╣${formatted}` : formatted;
};
